...
<x-mail::table>
| {{ __('Date') }}                         | {{ __('Shift') }}              | {{ __('Number of guests') }}        | {{ __('Status') }}              | {{ __('Code') }}        |
| :--------------------------------------: | :----------------------------: | :---------------------------------: | :-----------------------------: | :---------------------: |
| {{ $notifiable->date->format('d/m/Y') }} | {{ $notifiable->shift->time }} | {{ $notifiable->number_of_guests }} | {{ $notifiable->status->name }} | {{ $notifiable->code }} |
</x-mail::table>
